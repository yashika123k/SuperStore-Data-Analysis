...
This project demonstrates how Excel can be used as a full Business Intelligence platform by implementing proper data modeling principles and analytical thinking.

It bridges the gap between raw transactional data and executive decision-making insights.
